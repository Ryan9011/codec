    ...
    switch (channel_type) {
        ...
        case 0x06:
            ...
            if (channel === 0x01) {
                ...
                // skip 4 bytes
                decoded.leakage_alarm_config.report_interval = readUInt16LE(bytes.slice(offset + 5, offset + 7));
                decoded.leakage_alarm_config.report_times = readUInt16LE(bytes.slice(offset + 7, offset + 9));
            }
            offset += 9;
            break;
        case 0x10:
...
function readReportType(value) {
    ...
    return getValue(report_map, value);
}
